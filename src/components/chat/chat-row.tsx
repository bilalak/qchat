...
export const ChatRow: FC<ChatRowProps> = props => {
  ...
  // TODO Build out process for rewriting with suggestions
  // const [rewriteWithSuggestions, handleRewriteWithSuggestions] = useState(false)
  ...
  const toggleButton = (buttonId: string): void => {
    switch (buttonId) {
      ...
      case "CopyButton":
        ...
        break
      case "RewriteButton":
        // handleRewriteWithSuggestions(prevState => !prevState)
        setIsIconChecked(false)
        setThumbsUpClicked(false)
        setThumbsDownClicked(false)
        break
  ...
  //   toggleButton("SuggestionsButton")
          ...
          <div className="flex items-center gap-4">
            {props.type === "assistant" && props.showAssistantButtons && (
              <AssistantButtons
                ...
                // rewriteWithSuggestions={handleRewriteWithSuggestions}
              />
            )}
